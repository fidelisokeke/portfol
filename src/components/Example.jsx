...
export default function Example() {
        ...
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Sera tek</span>
              <img
                alt=""
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
             You can Browse through our catalog of phones and get started with us
            </p>
          </div>
        </div>
  ...
  <h2 className="text-3xl font-bold text-gray-800">Our Featured Products</h2>
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6">
